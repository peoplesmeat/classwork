...
public class DDBSPreparedStatement extends DDBSStatement 
    implements PreparedStatement 
{
     ...
     * Constructor
     */
    public DDBSPreparedStatement(Connection oracle, Connection mysql)
    {
    	super(oracle, mysql); 
    }
    ...
    {
    	return new DDBSResultSet(); // for now
    }
