 ...
 *	connect to the DDSWWW System.  This implements the 
...
public class DDSWWWConnection implements Connection {
     ...
     *Constructors 
     */	
    public DDSWWWConnection (Properties info) throws SQLException 
    {
    ...
    public CallableStatement prepareCall(String sql) 
    	throws SQLException
    {
    	return new DDSWWWCallableStatement(); // for now
    }
    ...
    public DatabaseMetaData getMetaData() 
    	throws SQLException
    {
    	return new DDSWWWDatabaseMetaData();
    }
