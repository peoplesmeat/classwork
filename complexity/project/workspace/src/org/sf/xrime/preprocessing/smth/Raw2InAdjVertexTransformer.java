 ...
 */
public class Raw2InAdjVertexTransformer extends Transformer{
  /**
   * Default constructor.
   */
  public Raw2InAdjVertexTransformer(){
    super();
  }
  /**
   * Normal constructor.
   ...
   * @param dest
   */
  public Raw2InAdjVertexTransformer(Path src, Path dest){
    super(src, dest);
  }
  /**
  ...
  public static void main(String[] args){
    try {
      int res = ToolRunner.run(new Raw2InAdjVertexTransformer(), args);
      System.exit(res);
    } catch (Exception e) {
      e.printStackTrace();
    }
