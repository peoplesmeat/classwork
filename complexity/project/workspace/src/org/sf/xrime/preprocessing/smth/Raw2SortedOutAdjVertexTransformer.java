 ...
 * list.</p>
 * <p>By "sorted", we mean the adjacent vertexes are sorted alphabetically within the list.</p>
 */
public class Raw2SortedOutAdjVertexTransformer extends Transformer{
  /**
   * Default constructor.
   */
  public Raw2SortedOutAdjVertexTransformer(){
    super();
  }
  /**
   * Normal constructor.
   ...
   * @param dest
   */
  public Raw2SortedOutAdjVertexTransformer(Path src, Path dest){
    super(src, dest);
  }
  /**
  ...
  public static class ReduceClass extends MapReduceBase
    ...
    public void reduce(Text key, Iterator<AdjVertex> values,
      ...
      TreeSet<String> orig_author_set = new TreeSet<String>();
  ...
  public static void main(String[] args){
    try {
      int res = ToolRunner.run(new Raw2SortedOutAdjVertexTransformer(), args);
      System.exit(res);
    } catch (Exception e) {
      e.printStackTrace();
    }
