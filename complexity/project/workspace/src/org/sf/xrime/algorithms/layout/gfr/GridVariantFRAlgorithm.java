...
/**
 * Input is raw graph in the form of outgoing adjacency list.
 ...
 *
 */
public class GridVariantFRAlgorithm extends GraphAlgorithm {
  /**
   * Default constructor.
   */
  public GridVariantFRAlgorithm(){
    super();
  }
  ...
  public static void main(String[] args){
    try {
      int res = ToolRunner.run(new GridVariantFRAlgorithm(), args);
      System.exit(res);
    } catch (Exception e) {
      e.printStackTrace();
    }
