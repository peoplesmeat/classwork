...
/**
 * This algorithm is used to assign a sequantial number to each vertex.
 * @author xue
 */
public class SequentialNumAssign extends GraphAlgorithm {
  /**
   * Used to assign sequentail numbers.
   */
  ...
  /**
   * Reducer. Single key is used to accummulate all vertexes in order to give
