...
/**
 * This is used to extract Rem(G,v).
 * @author xue
 */
public class ExtractRemains extends GraphAlgorithm {
  /**
   * Default constructor.
   */
  public ExtractRemains(){
    super();
  }
  ...
  public static class MapClass extends GraphAlgorithmMapReduceBase implements
    ...
    public void map(Text key, LabeledAdjBiSetVertex value,
      ...
      if(value.getStringLabel(ConstantLabels.BACKWARD_LABEL)==null &&
         value.getStringLabel(ConstantLabels.FINAL_LABEL)==null){
