...
/**
 * Forward trim is to trim those vertexes who have no ancestors. This class emit these
 * vertexes for backup purpose.
 * @author xue
 */
public class ForwardTrimPartA extends GraphAlgorithm {
  /**
   * Default constructor.
   */
  public ForwardTrimPartA(){
    super();
  }
  /**
   * Collected those vertexes to be trimmed.
   * @author xue
   */
  ...
  public void execute() throws ProcessorExecutionException {
    JobConf conf = new JobConf(context, ForwardTrimPartA.class);
    conf.setJobName("ForwardTrimPartA");
