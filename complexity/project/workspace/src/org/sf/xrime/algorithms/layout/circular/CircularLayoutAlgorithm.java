...
public class CircularLayoutAlgorithm extends GraphAlgorithm {
  /** Default constructor. */
  ...
  public void execute() throws ProcessorExecutionException {
    try {
      ...
      String temp_dir_prefix = getDestination().getPath().getParent().toString()+"/cla_"+
  ...
  public static void main(String[] args){
    try {
      int res = ToolRunner.run(new CircularLayoutAlgorithm(), args);
      System.exit(res);
    } catch (Exception e) {
      e.printStackTrace();
    }
