...
public class OutAdjVertex2StrongSetWithLabelTransformer extends Transformer {
	 ...
	 */
	  ...
	  public static class ReduceClass extends GraphAlgorithmMapReduceBase implements
	    Reducer<Text, LabeledAdjSetVertex, Text, AdjSetVertexWithTwoHopLabel>{

	    @Override
	    public void reduce(Text key, Iterator<LabeledAdjSetVertex> values,
	        OutputCollector<Text, AdjSetVertexWithTwoHopLabel> output, Reporter reporter)
	        throws IOException {
...
/*	      LabeledAdjSetVertex result = new LabeledAdjSetVertex();
	...
	public void execute() throws ProcessorExecutionException {
		...
		JobConf jobConf = new JobConf(conf,
				OutAdjVertex2StrongSetWithLabelTransformer.class);
	...
	public static void main(String[] args) {
		try {
			int res = ToolRunner.run(
					new OutAdjVertex2StrongSetWithLabelTransformer(), args);
			System.exit(res);
		} catch (Exception e) {
